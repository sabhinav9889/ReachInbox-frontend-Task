...
const Detail = ()=>{
    ...
    return(
        <div className="">
            <div className="p-2">
                <p className={`font-semibold p-2 pl-4 rounded-xl ${(dark)?'bg-upNav text-white':'bg-slate-200 text-black'} mb-4`}>Lead Details</p>   
                {
                entity1.map((ele, idx)=>(
            ...
            <div className="p-2">
                <p className={`font-semibold p-2 pl-4 rounded-xl ${(dark)?'bg-upNav text-white':'bg-slate-200 text-black'}`}>Activities</p>
                ...
                <div className="flex w-full mt-2 text-xs h-10">
                    <div className={`${(dark)?'bg-upNav':'bg-slate-200'} rounded-full w-8 h-8 mt-1`}>
